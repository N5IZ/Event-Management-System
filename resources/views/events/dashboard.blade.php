...
@section('content')
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
            <p>You don't have any Event yet, <a href="/events/create">Create Event</a></p>
        @endif
    </div>
    <div class="col-md-10 offset-md-1 dashboard-title-container">
        <h1>Event You participating</h1>
    </div>
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
            <p>You are not currently participating in any event, <a href="/">See all events</a></p>
        @endif
    </div>
@endsection
