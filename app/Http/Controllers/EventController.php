...
class EventController extends Controller
{
    ...
    public function joinEvent($id) {
        ...
        return redirect('/dashboard')->with('msg', 'Your attendance is confirmed at the event ' . $event->title);
    ...
    public function leaveEvent($id) {
        ...
        return redirect('/dashboard')->with('msg', 'You have successfully left the event: ' . $event->title);
